...
function countDivisors(num: number): number {
  let numDivisors: number = 1; //start at 1 to include the number itself
...
function numDivisorsTriangleNum(numOfDivisors: number): number {
  let currentNum: number = 1;
  let currentTriangleNum: number = 0;
